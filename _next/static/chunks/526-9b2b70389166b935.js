    ...
    8045: function (t, e, i) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.default = function (t) {
          ...
          "layout" in U && (U.layout && (W = U.layout), delete U.layout);
          var $ = T;
          if ("loader" in U) {
            if (U.loader) {
              var q = U.loader;
          ...
          [
            ...
            function (t) {
              ...
              return i.endsWith(".svg") && !e.dangerouslyAllowSVG
                ? i
                : ""
                    .concat(m.normalizePathTrailingSlash(e.path), i);
            },
          ],
          [
            "imgix",
              ...
              r(o, [
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.props.spy || this.props.hashSpy) {
                      var t = this.getScrollSpyContainer();
                      if (!l.default.isMounted(t)) {
                        var e = l.default.mount(t, this.props.spyThrottle);
      ...
      var n,
        ...
        l = {
          ...
          mount: function (t, e) {
            if (t) {
              ...
              return (
                ...
                function () {
                  (0, s.removePassiveEventListener)(t, "scroll", i),
                    l.scrollSpyContainers.splice(
          ...
          addSpyHandler: function (t, e) {
            ...
            i.spyCallbacks || (i.spyCallbacks = []), i.spyCallbacks.push(t);
          },
    ...
    9068: function (t, e, i) {
      ...
      let w = (t) => Array.isArray(t) && "number" == typeof t[0],
        ...
        T = (t, e, i = 10) => {
          ...
          for (let o = 0; o < r; o++) n += t(P(0, r - 1, o)) + ", ";
      ...
      let _ = [
        ...
        N = (t) => Boolean(t && "object" == typeof t && t.mix && t.toValue),
      ...
      function Y(t, e) {
        let i = !1,
          ...
          p = () => {
            let o = W.useManualTiming ? r.timestamp : performance.now();
            (i = !1),
              (r.delta = n
                ? 1e3 / 60
          ...
          v = (t) => {
            for (let e = 0; e < q.length; e++) s[q[e]].cancel(t);
          };
      ...
      let tc = (t) => Boolean(t && t.getVelocity);
      function th(t, e) {
        var i;
        let n = t.getValue("willChange");
        if (Boolean(tc(n) && n.add)) return n.add(e);
      }
      let td = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
        tp = "data-" + td("framerAppearId");
      function tf(t) {
        return t.props[tp];
      }
      let tm = (t) => 1e3 * t,
        ...
        let r = (e) =>
          (function (t, e, i, n, r) {
            let o,
              ...
              a = 0;
            do
              (o = ty((s = e + (i - e) / 2), n, r) - t) > 0 ? (i = s) : (e = s);
            while (Math.abs(o) > 1e-7 && ++a < 12);
            return s;
          })(e, 0, 1, t, i);
        return (t) => (0 === t || 1 === t ? t : ty(r(t), e, n));
      }
      let tw = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
        tx = (t) => (e) => 1 - t(1 - e),
        tS = tb(0.33, 1.53, 0.69, 0.99),
        tP = tx(tS),
        tT = tw(tP),
        tA = (t) =>
      ...
      function tj(t) {
        return "number" == typeof t
          ? 0 === t
          : null === t || "none" === t || "0" === t || tk(t);
      }
      let tO = (t, e, i) => (i > e ? e : i < t ? t : i),
        tV = {
          test: (t) => "number" == typeof t,
          parse: parseFloat,
          transform: (t) => t,
        },
        tD = { ...tV, transform: (t) => tO(0, 1, t) },
        tR = { ...tV, default: 1 },
        ...
        tF = (t, e) => (i) => {
          var n;
          return Boolean(
            ("string" == typeof i && tI.test(i) && i.startsWith(t)) ||
              (e && null != i && Object.prototype.hasOwnProperty.call(i, e))
          );
        },
        t_ = (t, e, i) => (n) => {
          if ("string" != typeof n) return n;
          let [r, o, s, a] = n.match(tB);
          return {
            [t]: parseFloat(r),
            [e]: parseFloat(o),
            [i]: parseFloat(s),
        ...
        tz = (t) => tO(0, 255, t),
        tU = { ...tV, transform: (t) => Math.round(tz(t)) },
        tN = {
          test: tF("rgb", "red"),
        ...
        tQ = {
          test: (t) => tN.test(t) || tH.test(t) || tG.test(t),
          parse: (t) =>
            tN.test(t) ? tN.parse(t) : tG.test(t) ? tG.parse(t) : tH.parse(t),
          transform: (t) =>
            "string" == typeof t
              ? t
      ...
      function t5(t) {
        let e = t.toString(),
          ...
          s = e.replace(
            ...
            (t) => (
              tQ.test(t)
                ? (n.color.push(o), r.push(t1), i.push(tQ.parse(t)))
                : t.startsWith("var(")
                ? (n.var.push(o), r.push("var"), i.push(t))
                : (n.number.push(o), r.push(t0), i.push(parseFloat(t))),
              ++o,
              "${}"
            )
          ),
      ...
      let ea = new Set(["auto", "none", "0"]),
        el = (t) => t === tV || t === tY,
        eu = (t, e) => parseFloat(t.split(", ")[e]),
        ec =
          (t, e) =>
          (i, { transform: n }) => {
            if ("none" === n || !n) return 0;
            let r = n.match(/^matrix3d\((.+)\)$/u);
            if (r) return eu(r[1], e);
            {
      ...
      class eb {
        ...
        scheduleResolve() {
          (this.isScheduled = !0),
            this.isAsync
              ? (ef.add(this),
                em || ((em = !0), X.read(ey), X.resolveKeyframes(eg)))
      ...
      let ew = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
        ex = (t) => (e) => "string" == typeof e && e.startsWith(t),
        eS = ex("--"),
        eP = ex("var(--"),
        eT = (t) => {
          let e = eP(t);
          return !!e && eA.test(t.split("/*")[0].trim());
        },
        eA =
      ...
      function eC(t, e, i = 1) {
        ...
        if (o) {
          let s = o.trim();
          return ew(s) ? parseFloat(s) : s;
        }
        return eT(r) ? eC(r, e, i + 1) : r;
      }
      let eM = (t) => (e) => e.test(t),
        ek = [
          tV,
      ...
      class eO extends eb {
        ...
        readKeyframes() {
          ...
          for (let n = 0; n < t.length; n++) {
            let r = t[n];
            if ("string" == typeof r && eT((r = r.trim()))) {
              let o = eC(r, e.current);
              void 0 !== o && (t[n] = o),
        ...
        resolveNoneKeyframes() {
          let { unresolvedKeyframes: t, name: e } = this,
            i = [];
          for (let n = 0; n < t.length; n++) tj(t[n]) && i.push(n);
          i.length &&
            (function (t, e, i) {
              let n = 0,
                r;
              ...
              if (r && i) for (let s of e) t[s] = es(i, r);
            })(t, i, e);
        }
        measureInitialState() {
      ...
      let eH = (t, e) => {
          let i = eN(t),
            n = eN(e);
          if (!i || !n) return eF(t, e);
          let r = { ...i };
          return (t) => (
            (r.red = e_(i.red, n.red, t)),
            (r.green = e_(i.green, n.green, t)),
            (r.blue = e_(i.blue, n.blue, t)),
      ...
      function eK(t, e) {
        let i = { ...t, ...e },
          n = {};
        for (let r in i)
          void 0 !== t[r] && void 0 !== e[r] && (n[r] = eX(t[r])(t[r], e[r]));
        return (t) => {
      ...
      let eG = (t, e) => {
        ...
        if (
          (eq.has(t) && !r.values.length) ||
          (eq.has(e) && !n.values.length)
        ) {
          var s, a;
          return eq.has(t) ? (i) => (i <= 0 ? t : e) : (i) => (i >= 1 ? e : t);
        }
        return e$(
          eZ(
            (function (t, e) {
      ...
      function e9(t = e0.visualDuration, e = e0.bounce) {
        let i =
            "object" != typeof t
          ...
          a = { done: !1, value: o },
          {
            ...
            let e = {
              velocity: e0.velocity,
              stiffness: e0.stiffness,
              damping: e0.damping,
              mass: e0.mass,
            ...
            if (!e3(t, e5) && e3(t, e2)) {
              if (t.visualDuration) {
                let i = t.visualDuration,
                  n = (2 * Math.PI) / (1.2 * i),
                  r = n * n,
                  o = 2 * tO(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(r);
                e = { ...e, mass: e0.mass, stiffness: r, damping: o };
              } else {
                let s = (function ({
                  duration: t = e0.duration,
                  bounce: e = e0.bounce,
                  velocity: i = e0.velocity,
                  mass: n = e0.mass,
                }) {
                  let r, o;
                  $(
                  ...
                  let s = 1 - e;
                  (s = tO(e0.minDamping, e0.maxDamping, s)),
                    (t = tO(e0.minDuration, e0.maxDuration, tv(t))),
                    s < 1
                      ? ((r = (e) => {
                          let n = e * s,
                            r = n * t,
                ...
                (e = { ...e, ...s, mass: e0.mass }).isResolvedFromDuration = !0;
              }
            }
            return e;
          })({ ...i, velocity: -tv(i.velocity || 0) }),
          f = d || 0,
          m = u / (2 * Math.sqrt(l * c)),
          v = s - o,
          y = tv(Math.sqrt(l / c)),
          b = 5 > Math.abs(v);
        n || (n = b ? e0.restSpeed.granular : e0.restSpeed.default),
          r || (r = b ? e0.restDelta.granular : e0.restDelta.default);
        let w;
        if (m < 1) {
          let x = e1(y, m);
          w = (t) =>
            s -
            Math.exp(-m * y * t) *
              (((f + m * y * v) / x) * Math.sin(x * t) + v * Math.cos(x * t));
        } else if (1 === m)
          w = (t) => s - Math.exp(-y * t) * (v + (f + y * v) * t);
        else {
          let S = y * Math.sqrt(m * m - 1);
          w = (t) => {
            let e = Math.min(S * t, 300);
            return (
              s -
              (Math.exp(-m * y * t) *
                ((f + m * y * v) * Math.sinh(e) + S * v * Math.cosh(e))) /
                S
            );
          };
        }
      ...
      let e6 = tb(0.42, 0, 1, 1),
        ...
        ii = (t) => {
          ...
          return "string" == typeof t
            ? ($(void 0 !== ie[t], `Invalid easing type '${t}'`), ie[t])
            : t;
        };
      function ir({
        duration: t = 300,
        ...
        let l = it(n) ? n.map(ii) : ii(n),
          ...
          h = (function (t, e, { clamp: i = !0, ease: n, mixer: r } = {}) {
            ...
            let a = (function (t, e, i) {
              ...
              l = a.length,
              u = (i) => {
                if (s && i < t[0]) return e[0];
                let n = 0;
                if (l > 1) for (; n < t.length - 2 && !(i < t[n + 1]); n++);
                let r = P(t[n], t[n + 1], i);
                return a[n](r);
              };
            return i ? (e) => u(tO(t[0], t[o - 1], e)) : u;
          })(c, e, {
            ease: Array.isArray(l)
              ? l
              : e.map(() => l || e8).splice(0, e.length - 1),
          });
        return {
      ...
      let io = (t) => {
        ...
        is = { decay: e4, inertia: e4, tween: ir, keyframes: ir, spring: e9 },
        ia = (t) => t / 100;
      class il extends eL {
        constructor(t) {
          super(t),
        ...
        tick(t, e = !1) {
          ...
          return (
            C && void 0 !== r && (A.value = eR(l, this.options, r)),
            v && v(A.value),
            C && this.finish(),
            A
          );
        ...
        get duration() {
          let { resolved: t } = this;
          return t ? tv(t.calculatedDuration) : 0;
        }
        get time() {
          return tv(this.currentTime);
        }
        set time(t) {
          (t = tm(t)),
            (this.currentTime = t),
        ...
        set speed(t) {
          ...
          (this.playbackSpeed = t), e && (this.time = tv(this.currentTime));
        }
        play() {
          if (
          ...
          let { driver: t = io, onPlay: e, startTime: i } = this.options;
      ...
      let iu = new Set(["opacity", "clipPath", "filter", "transform"]),
        ic = d(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
        ih = { anticipate: tA, backInOut: tT, circInOut: tM };
      class id extends eL {
        constructor(t) {
          super(t);
          let {
        ...
        initPlayback(t, e) {
          ...
          if (
            ("string" == typeof s && S() && (i = s) in ih && (s = ih[s]),
            y((n = this.options).type) ||
              "spring" === n.type ||
              !(function t(e) {
                return Boolean(
                  ("function" == typeof e && S()) ||
            ...
            1 === (t = v.keyframes).length && (t[1] = t[0]),
              (r = v.duration),
              (o = v.times),
              (s = v.ease),
              (a = "keyframes");
          ...
          return (
            (g.startTime = null != c ? c : this.calcStartTime()),
            this.pendingTimeline
              ? (b(g, this.pendingTimeline), (this.pendingTimeline = void 0))
              : (g.onfinish = () => {
                  let { onComplete: i } = this.options;
                  l.set(eR(t, this.options, e)),
                    i && i(),
                    this.cancel(),
                    this.resolveFinishedPromise();
                }),
        ...
        ib =
          ...
          (s) => {
            ...
            !(function ({
              ...
              c.duration && (c.duration = tm(c.duration)),
              c.repeatDelay && (c.repeatDelay = tm(c.repeatDelay)),
              void 0 !== c.from && (c.keyframes[0] = c.from);
            let h = !1;
            if (
              ((!1 !== c.type && (0 !== c.duration || c.repeatDelay)) ||
                ((c.duration = 0), 0 !== c.delay || (h = !0)),
              (tg.current || W.skipAnimations) &&
                ((h = !0), (c.duration = 0), (c.delay = 0)),
              h && !o && void 0 !== e.get())
            ) {
              let d = eR(c.keyframes, a);
              if (void 0 !== d)
                return (
                  X.update(() => {
            ...
            return !o && id.supports(c) ? new id(c) : new il(c);
          };
      function iw({ protectedKeys: t, needsAnimating: e }, i) {
        let n = t.hasOwnProperty(i) && !0 !== e[i];
        return (e[i] = !1), n;
      }
      function ix(t, e, { delay: i = 0, transitionOverride: n, type: r } = {}) {
        var o;
        let {
        ...
        for (let d in l) {
          let p = t.getValue(
            ...
            f = l[d];
          if (void 0 === f || (h && iw(h, d))) continue;
          let m = { delay: i, ...v(s || {}, d) },
            g = !1;
          if (window.MotionHandoffAnimation) {
            let y = tf(t);
            if (y) {
              let b = window.MotionHandoffAnimation(y, d, X);
              null !== b && ((m.startTime = b), (g = !0));
            }
          }
          th(t, d),
            p.start(
              ib(
                ...
                p,
                f,
                t.shouldReduceMotion && U.has(d) ? { type: !1 } : m,
                t,
                g
              )
            );
      ...
      function iS(t, e, i = {}) {
        ...
        let s = r ? () => Promise.all(ix(t, r, i)) : () => Promise.resolve(),
          a =
      ...
      let iR = (t) => (e) => V(e) && t(e, iD(e));
      function iL(t, e, i, n) {
        return iV(t, e, iR(i), n);
      }
      ...
      class iI {
        constructor(
          ...
          let o = iD(t),
            s = iF(o, this.transformPagePoint),
            { point: a } = s,
            { timestamp: l } = K;
          this.history = [{ ...a, timestamp: l }];
          let { onSessionStart: u } = e;
          u && u(t, iz(s, this.history)),
      ...
      function iz({ point: t }, e) {
        ...
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ;
              i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > tm(0.1)));

            )
              i--;
            if (!n) return { x: 0, y: 0 };
            let o = tv(r.timestamp - n.timestamp);
      ...
      function i$(t, e, i, n) {
        iW(t.x, e.x, i.x, n ? n.originX : void 0),
          iW(t.y, e.y, i.y, n ? n.originY : void 0);
      }
      function iq(t, e, i) {
        (t.min = i.min + e.min), (t.max = t.min + iH(e));
      }
      function iY(t, e, i) {
        (t.min = e.min - i.min), (t.max = t.min + iH(e));
      }
      function iX(t, e, i) {
      ...
      let iJ = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
        i0 = () => ({ x: iJ(), y: iJ() }),
        i1 = () => ({ min: 0, max: 0 }),
        i2 = () => ({ x: i1(), y: i1() });
      function i5(t) {
      ...
      function i4({ scale: t, scaleX: e, scaleY: i }) {
        return !i9(t) || !i9(e) || !i9(i);
      }
      function i6(t) {
        return (
          i4(t) ||
      ...
      class nu {
        ...
        updateAxis(t, e, i) {
          ...
          this.constraints &&
            ...
            (o = (function (t, { min: e, max: i }, n) {
              return (
                void 0 !== e && t < e
                  ? (t = n ? eB(e, t, n.min) : Math.max(t, e))
                  : void 0 !== i &&
                    t > i &&
                    (t = n ? eB(i, t, n.max) : Math.min(t, i)),
                t
              );
        ...
        resolveRefConstraints() {
          ...
          let s = (function (t, e, i) {
            ...
            a = { x: iK((t = o.layout.layoutBox).x, s.x), y: iK(t.y, s.y) };
          if (n) {
            let l = n(
              (function ({ x: t, y: e }) {
        ...
        startAxisValueAnimation(t, e) {
          ...
          return (
            ...
            i.start(ib(t, i, 0, e, this.visualElement, !1))
          );
        }
        stopAnimation() {
        ...
        scalePositionWithinConstraints() {
          ...
          if (!iN(e) || !i || !this.constraints) return;
          this.stopAnimation();
          let n = { x: 0, y: 0 };
          i5((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  r > n
                    ? (i = P(e.min, e.max - n, t.min))
                    : n > r && (i = P(t.min, t.max - r, e.min)),
                  tO(0, 1, i)
                );
      ...
      var nd,
        ...
        nm = i(5893),
        nv = i(7294);
      let ng = (0, nv.createContext)(null),
        ny = (0, nv.createContext)({}),
        nb = (0, nv.createContext)({}),
        nw = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      function nx(t, e) {
      ...
      let nS = {
        ...
        nP = {},
        { schedule: nT, cancel: nA } = Y(queueMicrotask, !1);
      class nE extends nv.Component {
        componentDidMount() {
          var t;
          let {
              visualElement: e,
      ...
      function nC(t) {
        let [e, i] = (function (t = !0) {
            ...
            let s = (0, nv.useCallback)(() => t && n && n(o), [o, n, t]);
            return !i && n ? [!1, s] : [!0];
          })(),
          n = (0, nv.useContext)(ny);
        return (0, nm.jsx)(nE, {
          ...t,
          layoutGroup: n,
          switchLayoutGroup: (0, nv.useContext)(nb),
          isPresent: e,
          safeToRemove: i,
        });
      }
      ...
      let nV = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        ...
        nL = (t) => "number" == typeof t || tY.test(t);
      function nB(t, e) {
      ...
      let nI = n_(0, 0.5, tC),
        nF = n_(0.5, 0.95, $);
      function n_(t, e, i) {
        return (n) => (n < t ? 0 : n > e ? 1 : i(P(t, e, n)));
      }
      function nz(t, e) {
      ...
      function nW(t, e, [i, n, r], o, s) {
        !(function (t, e = 0, i = 1, n = 0.5, r, o = t, s = t) {
          if (tq.test(e)) {
            e = parseFloat(e);
            let a = eB(s.min, s.max, e / 100);
            e = a - s.min;
          }
          if ("number" != typeof e) return;
          let l = eB(o.min, o.max, n);
          t === o && (l -= e),
            (t.min = nH(t.min, e, i, l, r)),
            (t.max = nH(t.max, e, i, l, r));
        })(t, e[i], e[n], e[r], e.scale, o, s);
      }
      let n$ = ["x", "scaleX", "originX"],
        nq = ["y", "scaleY", "originY"];
      function nY(t, e, i, n) {
        nW(t.x, e, n$, i ? i.x : void 0, n ? n.x : void 0),
          nW(t.y, e, nq, i ? i.y : void 0, n ? n.y : void 0);
      }
      function nX(t) {
      ...
      let n2 = {
        ...
        n5 = "undefined" != typeof window && void 0 !== window.MotionDebug,
        n3 = ["", "X", "Y", "Z"],
      ...
      function n7({
        ...
        return class {
              ...
              t(e, () => {
                (this.root.updateBlockedByResize = !0),
                  ...
                  (a = (function (t, e) {
                    ...
                    return X.read(n, !0), () => Z(n);
                  })(l, 250)),
                  nw.hasAnimatedSinceResize &&
                    ((nw.hasAnimatedSinceResize = !1), this.nodes.forEach(ra));
              });
            }
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    if (
                      ...
                      let c = { ...v(r, "layout"), onPlay: o, onComplete: a };
          ...
          update() {
            ...
            this.isUpdating || this.nodes.forEach(ro),
              (this.isUpdating = !1),
              ...
              this.clearAllSnapshots();
            let e = tt.now();
            (K.delta = tO(0, 1e3 / 60, e - K.timestamp)),
              (K.timestamp = e),
              (K.isProcessing = !0),
              G.update.process(K),
              G.preRender.process(K),
              G.render.process(K),
              (K.isProcessing = !1);
          }
          didUpdate() {
            this.updateScheduled ||
              ((this.updateScheduled = !0), nT.read(this.scheduleUpdate));
          }
          clearAllSnapshots() {
            this.nodes.forEach(rn), this.sharedNodes.forEach(rh);
          }
            ...
            let i = e.measureViewportBox(),
              n =
                (null === (t = this.scroll) || void 0 === t
                  ? void 0
                  : t.wasRoot) || this.path.some(rw);
            if (!n) {
              let { scroll: r } = this.root;
              r && (nn(i.x, r.offset.x), nn(i.y, r.offset.y));
            }
            return i;
          }
          ...
          applyTransform(t, e = !1) {
            ...
            for (let n = 0; n < this.path.length; n++) {
              ...
              !e &&
                ...
                r.scroll &&
                r !== r.root &&
                no(i, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
                i6(r.latestValues) && no(i, r.latestValues);
            }
            return i6(this.latestValues) && no(i, this.latestValues), i;
          }
          removeTransform(t) {
            let e = i2();
            nU(e, t);
            for (let i = 0; i < this.path.length; i++) {
              ...
              i4(n.latestValues) && n.updateSnapshot();
              let r = i2(),
                o = n.measurePageBox();
              nU(r, o),
                nY(
            ...
            return i6(this.latestValues) && nY(e, this.latestValues), e;
          }
          setTargetDelta(t) {
            (this.targetDelta = t),
          ...
          resolveTargetDelta(t = !1) {
            ...
            if (this.layout && (l || u)) {
              if (
                ...
                c && c.layout && 1 !== this.animationProgress
                  ? ((this.relativeParent = c),
                    ...
                    (this.relativeTarget = i2()),
                    (this.relativeTargetOrigin = i2()),
                    iX(
              ...
              if (this.relativeTarget || this.targetDelta) {
                if (
                  ((this.target ||
                    ((this.target = i2()), (this.targetWithTransforms = i2())),
                  this.relativeTarget &&
                    this.relativeTargetOrigin &&
                    this.relativeParent &&
                  ...
                  1 !== this.animationProgress
                    ? ((this.relativeParent = h),
                      ...
                      (this.relativeTarget = i2()),
                      (this.relativeTargetOrigin = i2()),
                      iX(this.relativeTargetOrigin, this.target, h.target),
                      nU(this.relativeTarget, this.relativeTargetOrigin))
                    : (this.relativeParent = this.relativeTarget = void 0);
                }
                n5 && n2.resolvedTargetDeltas++;
              }
            }
          }
              ...
              for (let a = 0; a < r; a++) {
                ...
                (!l ||
                  ...
                  (n &&
                    ...
                    o.scroll &&
                    o !== o.root &&
                    no(t, { x: -o.scroll.offset.x, y: -o.scroll.offset.y }),
                  s && ((e.x *= s.x.scale), (e.y *= s.y.scale), ni(t, s)),
                  n && i6(o.latestValues) && no(t, o.latestValues));
              }
          ...
          createProjectionDeltas() {
            (this.prevProjectionDelta = i0()),
              (this.projectionDelta = i0()),
              (this.projectionDeltaWithTransform = i0());
          }
          setAnimationOrigin(t, e = !1) {
            ...
            let s = i2(),
              ...
              d = Boolean(
                u && !h && !0 === this.options.crossfade && !this.path.some(rf)
              );
            this.animationProgress = 0;
            let p;
              ...
              if (
                ...
                if (
                  ...
                  p &&
                    ...
                    (l = p),
                    nK(a.x, l.x) && nK(a.y, l.y)))
                )
                  this.isProjectionDirty = !1;
                p || (p = i2()), nU(p, this.relativeTarget);
              }
              u &&
                ...
                (function (t, e, i, n, r, o) {
                  ...
                  for (let s = 0; s < nD; s++) {
                    ...
                    c
                      ? ((t[a] = Math.max(eB(nR(l), nR(u), n), 0)),
                        (tq.test(u) || tq.test(l)) && (t[a] += "%"))
                      : (t[a] = u);
                  }
                  (e.rotate || i.rotate) &&
                    (t.rotate = eB(e.rotate || 0, i.rotate || 0, n));
          ...
          startAnimation(t) {
            this.notifyListeners("animationStart"),
              ...
              (this.pendingAnimation = X.update(() => {
                (nw.hasAnimatedSinceResize = !0),
                  (this.currentAnimation = (function (t, e, i) {
                    let n = tc(t) ? t : tl(t);
                    return n.start(ib("", n, 1e3, i)), n.animation;
                  })(0, 1e3, {
                    ...t,
                    onUpdate: (e) => {
          ...
          applyTransformsToTarget() {
            ...
            if (e && i && n) {
              if (
                ...
                i = this.target || i2();
                let o = iH(this.layout.layoutBox.x);
                (i.x.min = t.target.x.min), (i.x.max = i.x.min + o);
                let s = iH(this.layout.layoutBox.y);
          ...
          getProjectionStyles(t) {
            ...
            if (this.needsReset)
              return (
                ...
                (n.opacity = ""),
                (n.pointerEvents =
                  nO(null == t ? void 0 : t.pointerEvents) || ""),
      ...
      function rt(t) {
        ...
        if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
          ...
          let l = i0();
          s
            ? i$(l, t.applyTransform(r, !0), i.measuredBox)
            : i$(l, n, i.layoutBox);
          let u = !nZ(a),
            c = !1;
          if (!t.resumeFrom) {
      ...
      function rp(t, e, i, n) {
        (t.min = eB(e.min, i.min, n)), (t.max = eB(e.max, i.max, n));
      }
      function rf(t) {
        return t.animationValues && void 0 !== t.animationValues.opacityExit;
      }
      let rm = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        rv = (t) =>
          "undefined" != typeof navigator &&
          navigator.userAgent &&
          navigator.userAgent.toLowerCase().includes(t),
        rg = rv("applewebkit/") && !rv("chrome/") ? Math.round : $;
      function ry(t) {
      ...
      function rb(t, e, i) {
        ...
        return (
          "position" === t ||
          ("preserve-aspect" === t &&
            ((n = nJ(e)), (r = nJ(i)), !(0.2 >= Math.abs(n - r))))
        );
      }
      function rw(t) {
        var e;
      ...
      let rE = new WeakMap(),
        ...
        rj = { some: 0, all: 1 },
        rO = (0, nv.createContext)({ strict: !1 }),
        rV = (0, nv.createContext)({
          transformPagePoint: (t) => t,
          isStatic: !1,
          reducedMotion: "never",
        }),
        rD = (0, nv.createContext)({});
      function rR(t) {
        return n(t.animate) || h.some((e) => s(t[e]));
      }
      function rL(t) {
        return Boolean(rR(t) || t.variants);
      }
      function rB(t) {
      ...
      let rU = Symbol.for("motionComponentSymbol"),
        rN = rI ? nv.useLayoutEffect : nv.useEffect,
        rH = [
          "animate",
          "circle",
          "defs",
      ...
      function rW(t) {
        ...
        else if (rH.indexOf(t) > -1 || /[A-Z]/u.test(t)) return !0;
        return !1;
      }
      let r$ = (t) => (e, i) => {
          let r = (0, nv.useContext)(rD),
            o = (0, nv.useContext)(ng),
            s = () =>
              (function (
                {
      ...
      function rZ(t, e, i) {
        ...
        if (
          ...
          let { originX: h = "50%", originY: d = "50%", originZ: p = 0 } = o;
          n.transformOrigin = `${h} ${d} ${p}`;
        }
      }
      let rK = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
        ...
        d.transform && (f && (p.transform = d.transform), delete d.transform),
          ...
          void 0 !== s &&
            (function (t, e, i = 1, n = 0, r = !0) {
              t.pathLength = 1;
              let o = r ? rK : rG;
              t[o.offset] = tY.transform(-n);
              let s = tY.transform(e),
                a = tY.transform(i);
              t[o.array] = `${s} ${a}`;
            })(d, s, a, l, !1);
      }
      let r0 = () => ({
        ...
        r1 = () => ({ ...r0(), attrs: {} }),
        r2 = (t) => "string" == typeof t && "svg" === t.toLowerCase();
      function r5(t, { style: e, vars: i }, n, r) {
      ...
      function r9(t, e, i, n) {
        for (let r in (r5(t, e, void 0, n), e.attrs))
          t.setAttribute(r3.has(r) ? r : td(r), e.attrs[r]);
      }
      function r4(t, { layout: e, layoutId: i }) {
        return (
          z.has(t) ||
          t.startsWith("origin") ||
          ((e || void 0 !== i) && (!!nP[t] || "opacity" === t))
        );
      }
      function r6(t, e, i) {
        var n;
      ...
      let r8 = ["x", "y", "width", "height", "cx", "cy", "r"],
        ot = {
          useVisualState: r$({
            scrapeMotionValuesFromProps: r7,
              ...
              a &&
                X.read(() => {
                  !(function (t, e) {
                    ...
                    X.render(() => {
                      rJ(n, r, r2(i.tagName), t.transformTemplate), r9(i, n);
                    });
                });
            },
          }),
      ...
      function oi(t, e, i) {
        for (let n in e) tc(e[n]) || r4(n, i) || (t[n] = e[n]);
      }
      function on(t, e) {
        let i = {},
          n = (function (t, e) {
            ...
            return (
              ...
              Object.assign(
                ...
                (function ({ transformTemplate: t }, e) {
                  return (0, nv.useMemo)(() => {
                    let i = r0();
                    return rZ(i, e, t), Object.assign({}, i.vars, i.style);
                  }, [e]);
                })(t, e)
              ),
              n
      ...
      try {
        (nd = require("@emotion/is-prop-valid").default) &&
          (os = (t) => (t.startsWith("on") ? !oo(t) : nd(t)));
      } catch (oa) {}
      function ol(t, e, i, n) {
        let r = (0, nv.useMemo)(() => {
          let i = r1();
          return (
            rJ(i, e, r2(n), t.transformTemplate),
            { ...i.attrs, style: { ...i.style } }
          );
        }, [e]);
        if (t.style) {
          let o = {};
          oi(o, t.style, t), (r.style = { ...o, ...r.style });
        }
        return r;
      }
      let ou = { current: null },
      ...
      class om {
        ...
        mount(t) {
          (this.current = t),
            ...
            (this.shouldReduceMotion =
              ...
              ("always" === this.reducedMotionConfig || ou.current)),
            this.parent && this.parent.children.add(this),
            this.update(this.props, this.presenceContext);
        }
        unmount() {
          for (let t in (op.delete(this.current),
        ...
        update(t, e) {
          ...
          (this.prevMotionValues = (function (t, e, i) {
            for (let n in e) {
              let r = e[n],
                o = i[n];
              if (tc(r)) t.addValue(n, r);
              else if (tc(o)) t.addValue(n, tl(r, { owner: t }));
              else if (o !== r) {
                if (t.hasValue(n)) {
                  let s = t.getValue(n);
                  ...
                  t.addValue(n, tl(void 0 !== a ? a : r, { owner: t }));
                }
              }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = tl(null === e ? void 0 : e, { owner: this })),
              this.addValue(t, i)),
            i
          );
        }
        readValue(t, e) {
          ...
          return (
            null != n &&
              ("string" == typeof n && (ew(n) || tk(n))
                ? (n = parseFloat(n))
                : !od(n) && t6.test(e) && (n = es(t, e)),
              this.setBaseTarget(t, tc(n) ? n.get() : n)),
            tc(n) ? n.get() : n
          );
        }
        setBaseTarget(t, e) {
        ...
        on(t, e) {
          return (
            this.events[t] || (this.events[t] = new tn()), this.events[t].add(e)
          );
        }
        notify(t, ...e) {
      ...
      class og extends ov {
        constructor() {
          super(...arguments), (this.type = "html"), (this.renderInstance = r5);
        }
        readValueFromInstance(t, e) {
          ...
          }
          {
            ...
            let r = window.getComputedStyle(t),
              o = (eS(e) ? r.getPropertyValue(e) : r[e]) || 0;
      ...
      class oy extends ov {
        constructor() {
          super(...arguments),
            (this.type = "svg"),
            (this.isSVGTag = !1),
            (this.measureInstanceViewportBox = i2);
        }
        getBaseTargetFromProps(t, e) {
          return t[e];
        }
        readValueFromInstance(t, e) {
          ...
          return (e = r3.has(e) ? e : td(e)), t.getAttribute(e);
        }
        scrapeMotionValuesFromProps(t, e, i) {
          return r7(t, e, i);
        }
        ...
        mount(t) {
          (this.isSVGTag = r2(t.tagName)), super.mount(t);
        }
      }
      let ob = (t, e) =>
          rW(t) ? new oy(e) : new og(e, { allowProjection: t !== nv.Fragment }),
        ow =
          ((np = {
            animation: {
              Feature: class extends ij {
                constructor(t) {
                  super(t),
                    t.animationState ||
                ...
                startObserver() {
                  ...
                  let { viewport: t = {} } = this.node.getProps(),
                    ...
                    o = {
                      ...
                      rootMargin: i,
                      threshold: "number" == typeof n ? n : rj[n],
                    },
                    s = (t) => {
                  ...
                  return (function (t, e, i) {
                    let n = (function ({ root: t, ...e }) {
                      ...
                      return (
                        n[r] ||
                          (n[r] = new IntersectionObserver(rk, {
                            root: t,
                            ...e,
                          })),
                        n[r]
                      ...
                      let [n, r, o] = k(t, i),
                        s = (t) => {
                          ...
                          let o = e(t),
                            ...
                            a = (t) => {
                              s(t, i.useGlobalTarget || O(n, t.target));
                            },
                            l = (t) => {
                              s(t, !1);
                            };
                      ...
                      return (
                        n.forEach((t) => {
                          ...
                          n.addEventListener("pointerdown", s, r),
                            t.addEventListener("focus", (t) => I(t, r), r);
                        }),
                        o
                      );
                    })(
            ...
            layout: { ProjectionNode: rP, MeasureLayout: nC },
          }),
                ...
                useRender: (function (t = !1) {
                  let e = (e, i, n, { latestValues: r }, o) => {
                    let s = rW(e) ? ol : on,
                      ...
                      u = e !== nv.Fragment ? { ...l, ...a, ref: n } : {},
                      { children: c } = i,
                      h = (0, nv.useMemo)(() => (tc(c) ? c.get() : c), [c]);
                    return (0, nv.createElement)(e, { ...u, children: h });
                  };
                  return e;
                })(e),
                createVisualElement: ob,
                Component: t,
              };
            return (function ({
              preloadedFeatures: t,
              ...
              function l(o, a) {
                ...
                let p,
                  ...
                  g = n(o, m);
                if (!m && rI) {
                  (h = f), (d = t), (0, nv.useContext)(rO).strict;
                  let y = (function (t) {
                  ...
                  (p = y.MeasureLayout),
                    (v.visualElement = (function (t, e, i, n, r) {
                      var o, s;
                      let { visualElement: a } = (0, nv.useContext)(rD),
                        l = (0, nv.useContext)(rO),
                        u = (0, nv.useContext)(ng),
                        c = (0, nv.useContext)(rV).reducedMotion,
                        h = (0, nv.useRef)(null);
                      (n = n || l.renderer),
                        !h.current &&
                          n &&
                        ...
                        (function (t, e, i, n) {
                          ...
                          (t.projection = new i(
                            ...
                            t.projection.setOptions({
                              layoutId: r,
                              layout: o,
                              alwaysMeasureLayout: Boolean(s) || (a && iN(a)),
                              visualElement: t,
                ...
                return (0, nm.jsxs)(rD.Provider, {
                  value: v,
                  children: [
                    p && v.visualElement
                      ? (0, nm.jsx)(p, { visualElement: v.visualElement, ...f })
                      : null,
                    i(
                      r,
                      o,
